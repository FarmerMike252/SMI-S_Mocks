...
pywbemcli -m NASHeadMockLoad.py
pywbemcli > connection save NASHeadMock

From then on the cached NASHeadMock will be used unless the file or any
...
def setup(conn, server, verbose):
    ...
    profile_fullname = 'SNIA_NAS Head'
